...
public class StorageTest {
    ...
    @Test
    public void load_fileNotExist_returnsEmptyList() throws AriaException {
    ...
    @Test
    public void save_and_load_roundTrip() throws AriaException {
    ...
    @Test
    public void load_markedDone_preservesStatus() throws AriaException {
        String path = tempDir.resolve("tasks.txt").toString();
        Storage storage = new Storage(path);
    ...
    @Test
    public void load_malformedLines_skipsGracefully() throws AriaException, IOException {
    ...
    @Test
    public void load_emptyLines_skippedSilently() throws AriaException, IOException {

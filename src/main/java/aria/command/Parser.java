...
public class Parser {
     ...
     * @throws AriaException if the input is invalid or unrecognised
     */
    public static Command parse(String input) throws AriaException {
        ...
        case "mark":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Please provide a task number to mark.");
            }
            return new Command(CommandType.MARK, parts[1].trim(), null, null, null);
        case "unmark":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Please provide a task number to unmark.");
            }
            return new Command(CommandType.UNMARK, parts[1].trim(), null, null, null);
        case "delete":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Please provide a task number to delete.");
            }
            return new Command(CommandType.DELETE, parts[1].trim(), null, null, null);
        case "todo": {
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! The description of a todo cannot be empty.");
            }
        ...
        case "deadline": {
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! The description of a deadline cannot be empty.");
            }
        ...
        case "event": {
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! The description of an event cannot be empty.");
            }
        ...
        case "fixed": {
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Usage: fixed <desc> /duration <hours>");
            }
        ...
        case "confirm":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Usage: confirm <num> <slot_number>");
            }
            return new Command(CommandType.CONFIRM, parts[1].trim(), null, null, null);
        case "find":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Please provide a keyword to search for.");
            }
            return new Command(CommandType.FIND, parts[1].trim(), null, null, null);
        case "archive":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Please provide a task number to archive.");
            }
        ...
        case "tag":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Usage: tag <num> <tagname>");
            }
            return new Command(CommandType.TAG, parts[1].trim(), null, null, null);
        case "untag":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Usage: untag <num> <tagname>");
            }
            return new Command(CommandType.UNTAG, parts[1].trim(), null, null, null);
        case "update":
            if (parts.length < 2 || parts[1].trim().isEmpty()) {
                throw new AriaException("OOPS!!! Usage: update <num> [/desc NEW] [/by NEW] "
